...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.cerulia.rpc.getCharacterSheetSchema'

export type QueryParams = {
  characterSheetSchemaRef: string
}
...
export interface Output {
  $type?: 'app.cerulia.rpc.getCharacterSheetSchema#output'
  characterSheetSchema?: { [_ in string]: unknown }
}
