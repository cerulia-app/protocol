...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.cerulia.rpc.getPlayerProfileView'
...
export interface Output {
  $type?: 'app.cerulia.rpc.getPlayerProfileView#output'
  profile?: { [_ in string]: unknown }
  blueskyFallbackProfile?: { [_ in string]: unknown }
  publicBranches?: { [_ in string]: unknown }
  profileSummary?: { [_ in string]: unknown }
}
